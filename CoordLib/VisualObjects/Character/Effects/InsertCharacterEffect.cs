...
namespace Coord
{
    ...
    public class InsertCharacterEffect : CharacterEffect, ICoordEditable
    {
        ...
        public static readonly DependencyProperty VisualObjectProperty = CreateProperty<VisualObject>(true, true, "VisualObject", typeof(InsertCharacterEffect));
        ...
        public static readonly DependencyProperty RectPointProperty = CreateProperty<RectPoint>(true, true, "RectPoint", typeof(InsertCharacterEffect));
        ...
        public static readonly DependencyProperty TranslateXProperty = CreateProperty<bool>(true, true, "TranslateX", typeof(InsertCharacterEffect));
        ...
        public static readonly DependencyProperty TranslateYProperty = CreateProperty<bool>(true, true, "TranslateY", typeof(InsertCharacterEffect));
