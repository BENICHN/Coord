...
namespace Coord
{
    ...
    public class ComplexCoordinatesSystem : CoordinatesSystem
    {
        ...
        public static readonly DependencyProperty OperationsProperty = CreateProperty<Func<Complex, Complex>>(true, true, "Operations", typeof(ComplexCoordinatesSystem));
        ...
        public static readonly DependencyProperty InvertOperationsProperty = CreateProperty<Func<Complex, Complex>>(true, true, "InvertOperations", typeof(ComplexCoordinatesSystem));
