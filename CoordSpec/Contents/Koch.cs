...
namespace CoordSpec
{
    public class Koch : VisualObject, IProgressive
    {
        ...
        public bool IsProgressGlobal { get => (bool)GetValue(IsProgressGlobalProperty); set => SetValue(IsProgressGlobalProperty, value); }
        public static readonly DependencyProperty IsProgressGlobalProperty = CreateProperty<Koch, bool>(true, true, true, "IsProgressGlobal");
