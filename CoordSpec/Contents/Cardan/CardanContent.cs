    ...
    public partial class MainWindow
    {
        ...
        private void OnLoaded()
        {
            ...
            var s1c = InCharacters(step1, PositiveReals)
                ...
                .Insert((12, null), (13, 13 + 1), equation, (5, 5 + 1), 1, true, false, default, syncp1b).Hide((Range<int>)(1, 1 + 3) + (9, 9 + 3));
            ...
            var step2 = InTex("(u+v)(u+v)^2+p(u+v)+q=0", textSize, inAnchorPoint, RectPoint.NaN).Align(PositiveReals, equation, 1);
            var s2c = InCharacters(step2, PositiveReals).Insert((11, null), (11, 11 + 1), step1, (6, 6 + 1), 1, syncp2b).Hide((5, 5 + 6));

            var uv2 = InCharacters(step2, (0, 0 + 5)).Insert(PositiveReals, null, step2, (5, 5 + 5), 0, true, false, default, syncp2a);
            ...
            var step3 = InTex("(u+v)(u^2+2uv+v^2)+p(u+v)+q=0", textSize, inAnchorPoint, RectPoint.NaN).Align(PositiveReals, equation, 1);
            var s3c = InTex("(u+v)(u^2+2uv+v^2)^2+p(u+v)+q=0", textSize, inAnchorPoint, RectPoint.NaN).Align(PositiveReals, equation, 1)
            ...
            var step4 = InTex("u^2(u+v)+v^2(u+v)+2uv(u+v)+p(u+v)+q=0", textSize, inAnchorPoint, RectPoint.NaN).Align(PositiveReals, equation, 1);
            var s4c = InCharacters(step4, PositiveReals)
                ...
                .Insert((24, null), (24, 24 + 1), step3, (16, 16 + 1), 1, true, false, default, syncp4b).Hide((Range<int>)(0, 0 + 7) + (8, 8 + 7) + (16, 16 + 8));

            var brace1 = InCharacters(step3, (5, 5 + 1)).Scale(PositiveReals, 0, 0, RectPoint.Left, 0, syncp4c);
            var brace2 = InCharacters(step3, (15, 15 + 1)).Scale(PositiveReals, 0, 0, RectPoint.Left, 0, syncp4c);

            var upv1 = InCharacters(step3, (0, 0 + 5)).Insert(PositiveReals, null, step4, (2, 2 + 5), 0, true, false, default, syncp4a);
            var upv2 = InCharacters(step3, (0, 0 + 5)).Insert(PositiveReals, null, step4, (10, 10 + 5), 0, true, false, default, syncp4a);
            var upv3 = InCharacters(step3, (0, 0 + 5)).Insert(PositiveReals, null, step4, (19, 19 + 5), 0, true, false, default, syncp4a);

            var u2 = InCharacters(step3, (6, 6 + 2)).Insert(PositiveReals, null, step4, (0, 0 + 2), 0, true, false, default, syncp4a)/*.TranslateAlongPath(PositiveReals, curveA, Translations.Y, 0, syncp4a)*/;
            var v2 = InCharacters(step3, (13, 13 + 2)).Insert(PositiveReals, null, step4, (8, 8 + 2), 0, true, false, default, syncp4a)/*.TranslateAlongPath(PositiveReals, curveA, Translations.Y, 0, syncp4a)*/;
            var twouv = InCharacters(step3, (9, 9 + 3)).Insert(PositiveReals, null, step4, (16, 16 + 3), 0, true, false, default, syncp4a)/*.TranslateAlongPath(PositiveReals, curveA, Translations.Y, 0, syncp4a)*/;
            ...
            var step5 = InTex("u^3+v^3+vu^2+uv^2+2uv(u+v)+p(u+v)+q=0", textSize, inAnchorPoint, RectPoint.NaN).Align(PositiveReals, equation, 1);
            var s5c = InCharacters(step5, PositiveReals)
                ...
                .Hide((Range<int>)(0, 0 + 2) + (3, 3 + 2) + (6, 6 + 3) + (10, 10 + 3));

            var brace51o = InCharacters(step4, (2, 2 + 1)).Scale(PositiveReals, 0, 0, RectPoint.Left, 0, syncp5c);
            var brace51f = InCharacters(step4, (6, 6 + 1)).Scale(PositiveReals, 0, 0, RectPoint.Left, 0, syncp5c);
            var brace52o = InCharacters(step4, (10, 10 + 1)).Scale(PositiveReals, 0, 0, RectPoint.Left, 0, syncp5c);
            var brace52f = InCharacters(step4, (14, 14 + 1)).Scale(PositiveReals, 0, 0, RectPoint.Left, 0, syncp5c);

            var u25a = InCharacters(step4, (0, 0 + 1)).Insert(PositiveReals, null, step5, (0, 0 + 1), 0, true, false, default, syncp5a);
            var u25b = InCharacters(step4, (0, 0 + 2)).Insert(PositiveReals, null, step5, (7, 7 + 2), 0, true, false, default, syncp5a);
            var v25a = InCharacters(step4, (8, 8 + 1)).Insert(PositiveReals, null, step5, (3, 3 + 1), 0, true, false, default, syncp5a);
            var v25b = InCharacters(step4, (8, 8 + 2)).Insert(PositiveReals, null, step5, (11, 11 + 2), 0, true, false, default, syncp5a);

            var u5a = InCharacters(step4, (3, 3 + 1)).Insert(PositiveReals, null, step5, (0, 0 + 1), 0, true, false, default, syncp5a)/*.TranslateAlongPath(PositiveReals, curveA, Translations.Y, 0, syncp5a)*/;
            var v5a = InCharacters(step4, (5, 5 + 1)).Insert(PositiveReals, null, step5, (3, 3 + 1), 0, true, false, default, syncp5a)/*.TranslateAlongPath(PositiveReals, curveA, Translations.Y, 0, syncp5a)*/;
            var u5b = InCharacters(step4, (11, 11 + 1)).Insert(PositiveReals, null, step5, (10, 10 + 1), 0, true, false, default, syncp5a)/*.TranslateAlongPath(PositiveReals, curveA, Translations.Y, 0, syncp5a)*/;
            var v5b = InCharacters(step4, (13, 13 + 1)).Insert(PositiveReals, null, step5, (6, 6 + 1), 0, true, false, default, syncp5a)/*.TranslateAlongPath(PositiveReals, curveA, Translations.Y, 0, syncp5a)*/;
            ...
            var step6 = InTex("u^3+v^3+uv(u+v)+2uv(u+v)+p(u+v)+q=0", textSize, inAnchorPoint, RectPoint.NaN).Align(PositiveReals, equation, 1);
            var s6c = InCharacters(step6, PositiveReals)
                .Brace(8, 3, 1, syncp6b)
                ...
                .Hide((Range<int>)(6, 6 + 2) + (9, 9 + 1) + (11, 11 + 1));

            var uvuvtouv = InMorphing(InCharacters(step5, (Range<int>)(6, 6 + 2) + (10, 10 + 2)), InCharacters(step6, (6, 6 + 2)), null, syncp6a);

            var u26 = InCharacters(step5, (7, 7 + 2)).Insert(PositiveReals, null, step6, (9, 9 + 1), 0, true, false, default, syncp6a);
            var v26 = InCharacters(step5, (11, 11 + 2)).Insert(PositiveReals, null, step6, (11, 11 + 1), 0, true, false, default, syncp6a);
            ...
            var step7 = InTex("u^3+v^3+(u+v)(3uv+p)+q=0", textSize, inAnchorPoint, RectPoint.NaN).Align(PositiveReals, equation, 1);
            var s7c = InCharacters(step7, PositiveReals)
                ...
                .Hide((Range<int>)(6, 6 + 5) + (12, 12 + 3) + (16, 16 + 1));

            var upv7a = InCharacters(step6, (8, 8 + 5)).Insert(PositiveReals, null, step7, (6, 6 + 5), 0, true, false, default, syncp7a);
            var upv7b = InCharacters(step6, (17, 17 + 5)).Insert(PositiveReals, null, step7, (6, 6 + 5), 0, true, false, default, syncp7a);
            var upv7c = InCharacters(step6, (24, 24 + 5)).Insert(PositiveReals, null, step7, (6, 6 + 5), 0, true, false, default, syncp7a);

            var uv7 = InCharacters(step6, (6, 6 + 2)).Insert(PositiveReals, null, step7, (13, 13 + 2), 0, true, false, default, syncp7a);
            var twouvto3uv = InMorphing(InCharacters(step6, (13, 13 + 4)), InCharacters(step7, (12, 12 + 3)), null, syncp7a);
            var p7 = InCharacters(step6, (23, 23 + 1)).Insert(PositiveReals, null, step7, (16, 16 + 1), 0, true, false, default, syncp7a);
            ...
            var sys = InCharacters(system, PositiveReals);
            var s7c3 = InCharacters(step7, PositiveReals);
            var threeuvpz = InCharacters(system, (1, 1 + 7)).Insert(PositiveReals, (0, 0 + 5), step7, (12, 12 + 5), 1, syncp8b);
            ...
            var step9 = InTex("u^3+v^3+(u+v)(0)+q=0", textSize, inAnchorPoint, RectPoint.NaN).Align(PositiveReals, equation, 1);
            var s9c = InCharacters(step9, PositiveReals).Insert((13, null), (15, 15 + 1), step7, (19, 19 + 1), 1, true, false, default, syncp9b).Hide((12, 12 + 1));

            var zero = InCharacters(system, (7, 7 + 1)).Insert(PositiveReals, null, step9, (12, 12 + 1), 0, syncp9a);
            ...
            var step10 = InTex("u^3+v^3+q=0", textSize, inAnchorPoint, RectPoint.NaN).Align(PositiveReals, equation, 1);
            var s10c = InCharacters(step10, PositiveReals).Insert((5, null), (6, 6 + 1), step9, (15, 15 + 1), 1, true, false, default, syncp10b);

            var uvzerotoempty = InCharacters(step9, (5, 5 + 9)).Scale(PositiveReals, 0, 0, RectPoint.Left, 0, syncp10a);
            ...
            var u3pv3pqz = InCharacters(system, (8, 8 + 9)).Insert(PositiveReals, null, step10, PositiveReals, 1, syncp11b);
            ...
            var u3pv3eqmq = InTex("u^3+v^3=-q", textSize, inAnchorPoint, RectPoint.NaN).Insert(PositiveReals, (0, 0 + 5), system, (8, 8 + 5), 1);
            var uveqmps3 = InTex(@"uv=-\frac{p}{3}", textSize, inAnchorPoint, RectPoint.NaN).Insert(PositiveReals, (0, 0 + 2), system, (2, 2 + 2), 1).Align(PositiveReals, u3pv3eqmq, 1, true, false, default);

            var sys1 = InCharacters(system, (1, 1 + 7)).Insert((1, 5), (1, 1 + 2), uveqmps3, (0, 0 + 2), 0, true, false, default, syncp12a).Insert((5, null), (5, 5 + 1), uveqmps3, (2, 2 + 1), 0, true, false, default, syncp12a).Hide((Range<int>)(0, 0 + 1) + (3, 3 + 2)).Opacity((6, 6 + 1), 0, 0, 0, syncp12a);
            ...
            var p = InCharacters(system, (5, 5 + 1)).Insert(PositiveReals, null, uveqmps3, (4, 4 + 1), 0, syncp12a);
            var three = InCharacters(system, (1, 1 + 1)).Insert(PositiveReals, null, uveqmps3, (6, 6 + 1), 0, syncp12a);
            var frac = InCharacters(uveqmps3, (5, 5 + 1)).Scale(PositiveReals, 0, 1, RectPoint.Center, 1, syncp12b);
            ...
            async Task Animate()
            {
                ...
                await Task.WhenAll(
                    ...
                    s3c.UnWrite((16, 16 + 1), true, false, 1, 0.75));
                ...
                await Task.WhenAll(
                    ...
                    u26.UnWrite((1, 1 + 1), true, false, 1, 0.75),
                    v26.UnWrite((1, 1 + 1), true, false, 1, 0.75));
                ...
                sys.Color((0, 0 + 1), brush, null, false);
                ...
                await Task.WhenAll(
                    ...
                    threeuvpz.Write((5, 5 + 2), true, false),
                    sys.Write((0, 0 + 1), true, false, 1, double.NaN, 1));
                ...
                sys.Color((1, 1 + 7), brush, null, false);
                ...
                sys.Color((8, 8 + 9), brush, null, false);
